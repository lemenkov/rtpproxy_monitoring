...
// Adapted from https://raw.githubusercontent.com/jbrukh/window
...
// the moving window
func (m *MovingWindow) PushBack(v RtpStats) {
...
// make a copy.
func (m *MovingWindow) Slice() []RtpStats {
...
func New(size, multiple int) *MovingWindow {
    ...
    return &MovingWindow{
        arr:  make([]RtpStats, capacity, capacity),
        size: size,
    }
}
